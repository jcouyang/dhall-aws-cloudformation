...
, `AWS::ARCZonalShift::ZonalAutoshiftConfiguration` =
    ./AWS::ARCZonalShift::ZonalAutoshiftConfiguration.dhall
...
, `AWS::B2BI::Capability` = ./AWS::B2BI::Capability.dhall
, `AWS::B2BI::Partnership` = ./AWS::B2BI::Partnership.dhall
, `AWS::B2BI::Profile` = ./AWS::B2BI::Profile.dhall
, `AWS::B2BI::Transformer` = ./AWS::B2BI::Transformer.dhall
...
, `AWS::Backup::RestoreTestingPlan` = ./AWS::Backup::RestoreTestingPlan.dhall
, `AWS::Backup::RestoreTestingSelection` =
    ./AWS::Backup::RestoreTestingSelection.dhall
...
, `AWS::CleanRooms::AnalysisTemplate` =
    ./AWS::CleanRooms::AnalysisTemplate.dhall
...
, `AWS::CloudFront::KeyValueStore` = ./AWS::CloudFront::KeyValueStore.dhall
...
, `AWS::CodeStarConnections::RepositoryLink` =
    ./AWS::CodeStarConnections::RepositoryLink.dhall
, `AWS::CodeStarConnections::SyncConfiguration` =
    ./AWS::CodeStarConnections::SyncConfiguration.dhall
...
, `AWS::Cognito::LogDeliveryConfiguration` =
    ./AWS::Cognito::LogDeliveryConfiguration.dhall
...
, `AWS::Connect::PredefinedAttribute` =
    ./AWS::Connect::PredefinedAttribute.dhall
...
, `AWS::Connect::SecurityProfile` = ./AWS::Connect::SecurityProfile.dhall
...
, `AWS::Connect::View` = ./AWS::Connect::View.dhall
, `AWS::Connect::ViewVersion` = ./AWS::Connect::ViewVersion.dhall
, `AWS::ConnectCampaigns::Campaign` = ./AWS::ConnectCampaigns::Campaign.dhall
, `AWS::ControlTower::EnabledControl` =
    ./AWS::ControlTower::EnabledControl.dhall
, `AWS::ControlTower::LandingZone` = ./AWS::ControlTower::LandingZone.dhall
...
, `AWS::DMS::DataProvider` = ./AWS::DMS::DataProvider.dhall
, `AWS::DMS::Endpoint` = ./AWS::DMS::Endpoint.dhall
, `AWS::DMS::EventSubscription` = ./AWS::DMS::EventSubscription.dhall
, `AWS::DMS::InstanceProfile` = ./AWS::DMS::InstanceProfile.dhall
, `AWS::DMS::MigrationProject` = ./AWS::DMS::MigrationProject.dhall
...
, `AWS::DocDB::EventSubscription` = ./AWS::DocDB::EventSubscription.dhall
...
, `AWS::EC2::SnapshotBlockPublicAccess` =
    ./AWS::EC2::SnapshotBlockPublicAccess.dhall
...
, `AWS::EKS::AccessEntry` = ./AWS::EKS::AccessEntry.dhall
...
, `AWS::EKS::PodIdentityAssociation` = ./AWS::EKS::PodIdentityAssociation.dhall
...
, `AWS::ElastiCache::ServerlessCache` =
    ./AWS::ElastiCache::ServerlessCache.dhall
...
, `AWS::ElasticLoadBalancingV2::TrustStore` =
    ./AWS::ElasticLoadBalancingV2::TrustStore.dhall
, `AWS::ElasticLoadBalancingV2::TrustStoreRevocation` =
    ./AWS::ElasticLoadBalancingV2::TrustStoreRevocation.dhall
, `AWS::Elasticsearch::Domain` = ./AWS::Elasticsearch::Domain.dhall
, `AWS::EntityResolution::IdMappingWorkflow` =
    ./AWS::EntityResolution::IdMappingWorkflow.dhall
...
, `AWS::FIS::TargetAccountConfiguration` =
    ./AWS::FIS::TargetAccountConfiguration.dhall
...
, `AWS::Glue::CustomEntityType` = ./AWS::Glue::CustomEntityType.dhall
...
, `AWS::HealthImaging::Datastore` = ./AWS::HealthImaging::Datastore.dhall
...
, `AWS::ImageBuilder::LifecyclePolicy` =
    ./AWS::ImageBuilder::LifecyclePolicy.dhall
, `AWS::ImageBuilder::Workflow` = ./AWS::ImageBuilder::Workflow.dhall
...
, `AWS::IoT::CertificateProvider` = ./AWS::IoT::CertificateProvider.dhall
...
, `AWS::IoT::SoftwarePackage` = ./AWS::IoT::SoftwarePackage.dhall
, `AWS::IoT::SoftwarePackageVersion` = ./AWS::IoT::SoftwarePackageVersion.dhall
...
, `AWS::Location::APIKey` = ./AWS::Location::APIKey.dhall
...
, `AWS::Logs::Delivery` = ./AWS::Logs::Delivery.dhall
, `AWS::Logs::DeliveryDestination` = ./AWS::Logs::DeliveryDestination.dhall
, `AWS::Logs::DeliverySource` = ./AWS::Logs::DeliverySource.dhall
, `AWS::Logs::Destination` = ./AWS::Logs::Destination.dhall
, `AWS::Logs::LogAnomalyDetector` = ./AWS::Logs::LogAnomalyDetector.dhall
...
, `AWS::MSK::Replicator` = ./AWS::MSK::Replicator.dhall
...
, `AWS::MediaLive::Multiplex` = ./AWS::MediaLive::Multiplex.dhall
, `AWS::MediaLive::Multiplexprogram` = ./AWS::MediaLive::Multiplexprogram.dhall
...
, `AWS::MediaPackageV2::Channel` = ./AWS::MediaPackageV2::Channel.dhall
, `AWS::MediaPackageV2::ChannelGroup` =
    ./AWS::MediaPackageV2::ChannelGroup.dhall
, `AWS::MediaPackageV2::ChannelPolicy` =
    ./AWS::MediaPackageV2::ChannelPolicy.dhall
, `AWS::MediaPackageV2::OriginEndpoint` =
    ./AWS::MediaPackageV2::OriginEndpoint.dhall
, `AWS::MediaPackageV2::OriginEndpointPolicy` =
    ./AWS::MediaPackageV2::OriginEndpointPolicy.dhall
...
, `AWS::NeptuneGraph::Graph` = ./AWS::NeptuneGraph::Graph.dhall
, `AWS::NeptuneGraph::PrivateGraphEndpoint` =
    ./AWS::NeptuneGraph::PrivateGraphEndpoint.dhall
...
, `AWS::NetworkFirewall::TLSInspectionConfiguration` =
    ./AWS::NetworkFirewall::TLSInspectionConfiguration.dhall
...
, `AWS::OpenSearchServerless::LifecyclePolicy` =
    ./AWS::OpenSearchServerless::LifecyclePolicy.dhall
...
, `AWS::PCAConnectorAD::Connector` = ./AWS::PCAConnectorAD::Connector.dhall
, `AWS::PCAConnectorAD::DirectoryRegistration` =
    ./AWS::PCAConnectorAD::DirectoryRegistration.dhall
, `AWS::PCAConnectorAD::ServicePrincipalName` =
    ./AWS::PCAConnectorAD::ServicePrincipalName.dhall
, `AWS::PCAConnectorAD::Template` = ./AWS::PCAConnectorAD::Template.dhall
, `AWS::PCAConnectorAD::TemplateGroupAccessControlEntry` =
    ./AWS::PCAConnectorAD::TemplateGroupAccessControlEntry.dhall
...
, `AWS::S3::AccessGrant` = ./AWS::S3::AccessGrant.dhall
, `AWS::S3::AccessGrantsInstance` = ./AWS::S3::AccessGrantsInstance.dhall
, `AWS::S3::AccessGrantsLocation` = ./AWS::S3::AccessGrantsLocation.dhall
...
, `AWS::S3Express::BucketPolicy` = ./AWS::S3Express::BucketPolicy.dhall
, `AWS::S3Express::DirectoryBucket` = ./AWS::S3Express::DirectoryBucket.dhall
...
, `AWS::SageMaker::InferenceComponent` =
    ./AWS::SageMaker::InferenceComponent.dhall
...
, `AWS::WorkSpacesThinClient::Environment` =
    ./AWS::WorkSpacesThinClient::Environment.dhall
