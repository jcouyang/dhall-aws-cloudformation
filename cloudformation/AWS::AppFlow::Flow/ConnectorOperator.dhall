{ Type =
    ...
    , Slack : Optional (./../../Fn.dhall).CfnText
    , Trendmicro : Optional (./../../Fn.dhall).CfnText
    , Veeva : Optional (./../../Fn.dhall).CfnText
...
, default =
  ...
  , Slack = None (./../../Fn.dhall).CfnText
  , Trendmicro = None (./../../Fn.dhall).CfnText
  , Veeva = None (./../../Fn.dhall).CfnText
