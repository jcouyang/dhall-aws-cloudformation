            ...
            ( toMap
                ...
                , Action =
                    JSON.array
                      ...
                      , JSON.string "codecommit:MergeBranchesByFastForward"
                      , JSON.string "codecommit:MergeBranchesBySquash"
                      , JSON.string "codecommit:MergeBranchesByThreeWay"
                      , JSON.string "codecommit:UpdateDefaultBranch"
                      , JSON.string "codecommit:BatchDescribeMergeConflicts"
                      , JSON.string "codecommit:CreateUnreferencedMergeCommit"
                      , JSON.string "codecommit:DescribeMergeConflicts"
                      ...
                      , JSON.string "codecommit:DescribePullRequestEvents"
                      , JSON.string "codecommit:GetCommentsForPullRequest"
                      , JSON.string "codecommit:GetCommitsFromMergeBase"
                      , JSON.string "codecommit:GetMergeConflicts"
                      , JSON.string "codecommit:GetPullRequest"
                      , JSON.string "codecommit:ListPullRequests"
                      , JSON.string "codecommit:MergePullRequestByFastForward"
                      , JSON.string "codecommit:MergePullRequestBySquash"
                      , JSON.string "codecommit:MergePullRequestByThreeWay"
                      , JSON.string "codecommit:PostCommentForPullRequest"
                      , JSON.string "codecommit:UpdatePullRequestDescription"
                      , JSON.string "codecommit:UpdatePullRequestStatus"
                      , JSON.string "codecommit:UpdatePullRequestTitle"
                      ...
                      , JSON.string "codecommit:GetCommentsForComparedCommit"
                      , JSON.string "codecommit:PostCommentForComparedCommit"
                      ...
                      , JSON.string "codecommit:UpdateRepositoryDescription"
                      ...
                      , JSON.string "codecommit:TestRepositoryTriggers"
                      , JSON.string "codecommit:GetBranch"
                      , JSON.string "codecommit:GetCommit"
                      , JSON.string "codecommit:UploadArchive"
                      , JSON.string "codecommit:GetUploadArchiveStatus"
