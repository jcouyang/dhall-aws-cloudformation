{ Type =
    ...
    , AWSSecretsManagerGetSecretValuePolicy :
        Optional (./SecretArnSAMPT.dhall).Type
    ...
    , DynamoDBWritePolicy : Optional (./TableSAMPT.dhall).Type
    ...
    , S3WritePolicy : Optional (./BucketSAMPT.dhall).Type
    ...
    , SSMParameterReadPolicy : Optional (./ParameterNameSAMPT.dhall).Type
