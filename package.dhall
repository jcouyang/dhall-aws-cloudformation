...
Replace the `0.7.52` with the latest version in [releases](https://github.com/jcouyang/dhall-aws-cloudformation/releases)
```sh
...
```
```dhall
let Cloudformation = https://github.com/jcouyang/dhall-aws-cloudformation/releases/download/0.7.52/package.dhall sha256:dcd5b64856fcc76da7f846e7e1027786d0818b1b5a1029ee36de9e1c14fdb7c3
```
-}
